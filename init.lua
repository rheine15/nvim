...
-- Default border for LSP hovers, signature help, and other floating windows (|:help 'winborder'|).
-- Matches the diagnostic float style above; helps dense hover docs (e.g. C#/OmniSharp) read as a panel.
